...
public class StudentDAO extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		DataBean db = service.calculate(processDataField(student.getData()));
	...
	protected StudentBean getStudentDetails(HttpServletRequest req) {
		...
		student.setEmail(req.getParameter("phone").toString());
	...
	protected void insertStudentToDb(Connection con, StudentBean s, DataBean d) {
